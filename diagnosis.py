...
if __name__ == '__main__':
  ...
  # 学習済みの機械学習モデルに入力データを与えて、出力を取得する
    ...
    with open(cir + 'pair_list', 'r') as f:   # simular.ipynbで作成した信号線の統合情報を取得
