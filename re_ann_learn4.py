...
learning_time_file = model_folder + "learning_time"  # モデルの学習時間を保存するファイル
...
def build_and_train_model(input_data, correct_data, model_id):
    ...
    with open(learning_time_file, "a") as f:
        f.write("モデル" + str(model_id) + ":" + str(training_time) + "\n")
...
if __name__ == '__main__':
    ...
    if test_flag == True:
        ...
        not_100_percent_models_file = model_folder + cir + 'not_100_percent_models'
        data_correct_rate_file = model_folder + cir + 'data_and_correct_rate'
        lerning_time_file = model_folder + "learning_time"
