# ann_learn15.pyを編集したプログラム。
# モデルごとに中間ノードを設定したい場合に対応。
# learn_data_delite3.ipynbで、作成したエポック数を読み込んで、モデルごとにエポック数を設定できるようにした。
...
not_100_percent_models_file = None  # 正解率が100%でなかったモデルの記録ファイル
...
if __name__ == '__main__':
    ...
    not_100_percent_models_file = model_folder + cir + 'not_100_percent_models.txt'  # 正解率が100%でなかったモデルの記録ファイル
